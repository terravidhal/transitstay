  ...
  return (
    ...
    >
      <div className="absolute flex flex-col gap-[64px] items-start" style={{ left: '50%', top: '106px', transform: 'translateX(-50%)', width: '667px' }}>
        <div className="flex items-start justify-between w-full">
          <div className="flex flex-col items-start">
            ...
            <p className="font-inter font-light not-italic text-[14px] leading-normal tracking-[0.28px] w-[279px] mt-[71px]" style={{ color: 'rgba(255,255,255,0.8)' }}>Your trusted companion for personalized travel suggestions. You can also get the mobile application</p>
        ...
        <div className="flex items-start justify-between" style={{ width: '653px' }}>
          <div className="flex flex-col gap-0 items-start">
            ...
            <p className="font-inter font-light not-italic text-[12px] leading-normal tracking-[0.24px] w-[330px] mt-[47px]" style={{ color: 'rgba(255,255,255,0.8)' }}>Enter your email address to stay updated.</p>
          ...
          <div className="flex flex-col gap-[19px] items-start leading-normal" style={{ width: '128px' }}>
            ...
            <div className="flex flex-col gap-[32px] items-start font-inter font-light not-italic text-[18px] tracking-[0.36px] w-full" style={{ color: 'rgba(255,255,255,0.8)' }}>
      ...
      <div className="absolute flex flex-col gap-[30px] items-center" style={{ left: '50%', top: '884px', transform: 'translateX(-50%)', width: '675px' }}>
        <div className="font-inter font-light not-italic text-[16px] leading-normal tracking-[0.32px] whitespace-nowrap relative w-full" style={{ color: 'rgba(255,255,255,0.6)', height: '20px' }}>
        ...
        <div style={{ marginTop: '20px' }}>{langSelector2}</div>
      </div>
    </div>
  );
}
