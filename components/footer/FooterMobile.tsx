...
import { imgIcon, imgIcon1, imgSocialMedia } from '../../lib/images';
    ...
    >
      ...
      className="absolute flex flex-col gap-[50px] items-start" style={{ left: '50%', top: '63px', transform: 'translateX(-50%)', width: '335px' }}>
        <div className="flex flex-col items-start">
          ...
          <p className="font-inter font-light not-italic text-[12px] leading-normal tracking-[0.24px] w-[315.736px] opacity-[0.8] mt-[27.16px]" style={{ color: 'rgba(255,255,255,0.8)' }}>Your trusted companion for personalized travel suggestions. You can also get the mobile application</p>
          <div className="flex items-center justify-between w-[332px] mt-[35px]">
        ...
        <div className="flex gap-[30px] items-start leading-normal w-full">
          <div className="flex flex-col gap-[14px] items-start" style={{ width: '142px' }}>
            ...
            <div className="flex opacity-[0.7] flex-col gap-[15px] items-start font-inter font-light not-italic text-[12px] tracking-[0.24px] w-full" style={{ color: 'rgba(255,255,255,0.8)' }}>
        ...
        <div className="flex flex-col items-start w-full">
          ...
          <p className="font-inter opacity-[0.7] font-light not-italic text-[12px] leading-normal tracking-[0.24px] w-[293px] mt-[10.99px]" style={{ color: 'rgba(255,255,255,0.8)' }}>Get travel tips and exclusive offers delivered to your inbox.</p>
          ...
          <p className="font-inter font-light not-italic text-[12px] leading-normal tracking-[0.24px] w-[335px] mt-[19px]" style={{ color: 'rgba(255,255,255,0.8)', fontSize: 0 }}>
            <span className="opacity-[0.7] text-[12px] leading-normal">{`By subscribing, you agree to receive marketing emails from TransitStay. You can unsubscribe at any time. Read our `}</span>
            <span className="text-[12px] font-inter font-medium leading-normal underline">Privacy Policy</span>
            <span className="opacity-[0.7] text-[12px] leading-normal">{` to learn how we handle your data.`}</span>
          </p>

             <div className="relative h-[22px] w-[180px] ml-[5px] mt-[40px]">
              <img alt="" className="block w-full h-full" src={imgSocialMedia} />
            </div>
            <div className="h-[1px] w-full mt-[30px]" style={{ backgroundColor: 'rgba(255,255,255,0.5)' }}>
          <hr className="border-t border-white mb-[30px]" />
        </div>
        </div>
      </div>

      <div className="absolute flex items-center justify-center" style={{ left: '50%', top: '850px', transform: 'translateX(-50%)', width: '306px' }}>
