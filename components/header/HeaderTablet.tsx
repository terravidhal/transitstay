...
export default function HeaderTablet() {
  return (
    <div className="hidden md:block lg:hidden fixed top-0 left-0 right-0 z-50 h-[95px] pointer-events-none">
      <div
      ...
      >
        ...
        >
          ...
          {/* Share */}
          <div
            className="relative flex items-center overflow-hidden rounded-[100px] shrink-0"
            style={{ width: '157px', height: '45px', backdropFilter: 'blur(45px)', backgroundColor: 'black' }}
          >
            <div
              className="absolute flex items-center justify-between"
              style={{ left: '50%', top: '50%', transform: 'translate(-50%, -50%)', width: '124px' }}
            >
              <div className="relative shrink-0 w-[20px] h-[20px]">
                <img alt="" className="absolute block w-full h-full" src={imgIcons8Share1} />
              </div>
              <p className="font-montserrat font-medium text-[15px] text-center text-white whitespace-nowrap leading-normal">
                Share Article
              </p>
            </div>
          </div>
